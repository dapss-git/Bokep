...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        let api = global.API("theresav", "/berita/okezone", {}, "apikey");
        ...
        let linkPreview = img ? await makeLinkPreview(conn, img, headline.title, "Okezone News", headline.link || headline.url) : null;
