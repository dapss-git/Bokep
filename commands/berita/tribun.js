...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        let api = global.API("theresav", "/berita/tribun", {}, "apikey");
        ...
        let linkPreview = img ? await makeLinkPreview(conn, img, headline.title, "Tribun News", headline.link || headline.url) : null;
