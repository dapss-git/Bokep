...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        let api = global.API("theresav", "/berita/detik", {}, "apikey");
        ...
        let linkPreview = img ? await makeLinkPreview(conn, img, headline.title, "Detik News", headline.link || headline.url) : null;
