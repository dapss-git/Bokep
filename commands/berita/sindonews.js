...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        let api = global.API("theresav", "/berita/sindonews", {}, "apikey");
        ...
        let linkPreview = img ? await makeLinkPreview(conn, img, headline.title, "Sindonews", headline.link || headline.url) : null;
