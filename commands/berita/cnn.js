...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        let api = global.API("theresav", "/berita/cnn", {}, "apikey");
        ...
        let linkPreview = img ? await makeLinkPreview(conn, img, headline.title, "CNN Indonesia", headline.link || headline.url) : null;
