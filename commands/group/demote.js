...
const handler = async (m, {
    ...
    if (ownerNums.includes(toNum(who))) return m.reply("❌ Tidak bisa mendemote Owner Grup");
    if (toNum(who) === toNum(botJid)) return m.reply("❌ Tidak bisa mendemote Bot sendiri");
