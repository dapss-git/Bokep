let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        const res = await fetch(global.API('theresav', '/image/todisney', {}, 'apikey'), {
            method: 'POST',
            body: form
        })
        ...
        await conn.sendMessage(m.chat, { image: result, caption: '🎀 Done convert disney' }, { quoted: m })
